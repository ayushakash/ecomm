  ...
  const profileSections = [
    {
      ...
      items: [
        ...
        { label: 'Role', value: 'Administrator', icon: 'shield-checkmark-outline' },
      ]
    },
    {
      ...
      items: [
        ...
        { label: 'Admin Since', value: user?.createdAt ? new Date(user.createdAt).toLocaleDateString() : 'N/A', icon: 'calendar-outline' },
        { label: 'Last Login', value: 'Today', icon: 'time-outline' },
        { label: 'Access Level', value: 'Full Access', icon: 'key-outline' },
      ]
    }
  ];
      ...
      >
        ...
        <View style={styles.avatarSection}>
          ...
          <View style={styles.adminBadge}>
            <Ionicons name="shield-checkmark" size={16} color={THEME.background} />
