                      ...
                      <div className="flex-1">
                        ...
                        {addressForm.coordinates.latitude && addressForm.coordinates.longitude ? (
                          <div className="text-xs text-green-700 bg-green-50 border border-green-200 rounded-lg px-3 py-2 inline-block font-medium break-all">
                            ✓ Location captured: {addressForm.coordinates.latitude.toFixed(4)}, {addressForm.coordinates.longitude.toFixed(4)}
                          </div>
                        ) : (
                          <div className="text-xs text-red-700 bg-red-50 border border-red-200 rounded-lg px-3 py-2 inline-block font-medium">
                            ⚠️ Please click the button to capture your location
                          </div>
                        )}
                      </div>
                      <button
                      ...
                      >
                        {capturingCoordinates ? (
                          ...
                          <>
                            ...
                            {addressForm.coordinates.latitude ? 'Update Location' : 'Capture Now'}
                          </>
                        )}
                      </button>
                    </div>
