...
const MerchantAnalytics = () => {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Merchant Analytics Dashboard</h1>
        <p className="text-gray-600">Overview of your sales, orders, and revenue trends</p>
      </div>
