  ...
  return (
    <div className="group relative bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden border border-gray-100">
      ...
      <div className="px-3 pb-3 flex items-center justify-between">
        ...
        {/* ADD / Counter / Options button */}
        {product.totalStock > 0 && (
          hasVariants ? (
            <Link
              to={`/products/${product._id}`}
              className="bg-white text-primary-700 border border-primary-300 px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm hover:bg-primary-50 transition-colors active:scale-95"
            >
              Options
            </Link>
          ) : cartItem ? (
            <div className="flex items-center bg-white rounded-lg shadow-sm border border-primary-200 overflow-hidden">
              <button
            ...
            <button
              onClick={handleAdd}
              className="bg-white text-primary-700 border border-primary-300 px-4 py-1.5 rounded-lg text-sm font-bold shadow-sm hover:bg-primary-50 transition-colors active:scale-95"
            >
              ADD
            </button>
          )
